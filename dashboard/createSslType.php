      ...
      <div class="content">
        <div class="row">
          ...
          ?>
              ...
              <div class="row">
                  <div class="col-12">
                      <?php echo "<br />"; insertAds('dash25', false);?>
                  </div>
              </div>
            ...
            <div class="row">
                <div class="col-md-6">
                  <div class="card">
                    <div class="card-header text-center">
                      <h5 class="card-title">Free SSL Certificate</h5>
                      <p class="card-category">
                          Best for Subdomains and Custom Domains!
                          <ul class="list-unstyled">
                            <li><i class="nc-icon nc-simple-remove text-danger"></i> Valid for 90 Days</li>
                            <li><i class="nc-icon nc-check-2 text-success"></i> Trusted by most modern browsers</li>
                        </ul>
                      </p>
                    </div>
                    <div class="card-content">
                      <table class="table table-borderless">
                        <tbody>
                          <tr>
                            <td>
                              <a href="api/createFreeSslCertificate.php" class="btn btn-round btn-success btn-block" onclick="CreateNewProductEvent('Free SSL');"><i class="nc-icon nc-simple-add"></i> Create Certificate</a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                ...
                <div class="col-md-6">
                  <div class="card">
                    <div class="card-header text-center">
                      <h5 class="card-title">Self-Signed Certificate</h5>
                      <p class="card-category">
                          Best for Cloudflare!
                        <ul class="list-unstyled">
                            <li><i class="nc-icon nc-check-2 text-success"></i> Valid for 10 Years</li>
                            <li><i class="nc-icon nc-simple-remove text-danger"></i> Not trusted by browsers</li>
                        </ul>
                      </p>
                    </div>
                    <div class="card-content">
                    <table class="table table-borderless">
                        <tbody>
                          <tr>
                            <td>
                              <a href="api/createSelfSignedCertificate.php" class="btn btn-round btn-success btn-block" onclick="CreateNewProductEvent('Self-Signed SSL');"><i class="nc-icon nc-simple-add"></i> Create Certificate</a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
              ...
              <div class="row">
                  <div class="col-12">
                      <?php echo "<br />"; insertAds('dash26', false);?>
                  </div>
              </div>
