 ...
 */
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $_SESSION['newDomain'] = htmlspecialchars($_POST['domain']) . "." . htmlspecialchars($_POST['extension']);
      ...
      <div class="content">
        <div class="row">
          ...
          ?>
              ...
              <div class="row">
                  <div class="col-12">
                      <?php echo "<br />"; insertAds('dash09', false);?>
                  </div>
              </div>
            ...
            <div class="row">
                    ...
                    <div class="card-content">
                      <table class="table table-borderless">
                        <tbody>
                          <tr>
                            <td>
                                <form class="text-center col-md-10 offset-lg-1 offset-md-0" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                  <div class="row text-left">
                                    <div class="col-md-12 col-lg-6">
                                    <label for="domain">Domain:</label>
                                      <input type="text" id="domain" name="domain" class="form-control text-center" placeholder="yourdomain" aria-describedby="domainHelpBlock">
                                    </div>
                                    <div class="col-md-12 col-lg-6">
                                  ...
                                  <small id="domainHelpBlock" class="text-center form-text text-muted">
              ...
              <div class="row">
                  <div class="col-12">
                      <?php echo "<br />"; insertAds('dash10', false);?>
                  </div>
              </div>
